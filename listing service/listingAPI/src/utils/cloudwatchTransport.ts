...
import ICloudWatchLogsConfigOptions from "../interface/ICloudwatchlogsconfigoptions";

export default class CloudWatchLogsTransport extends TransportStream {
  ...
  constructor(
    ...
    logConfig: ICloudWatchLogsConfigOptions,
  ...
  public static Create(): CloudWatchLogsTransport {
    ...
    const logConfiguration: ICloudWatchLogsConfigOptions = {
